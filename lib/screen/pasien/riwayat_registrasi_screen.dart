...
class RiwayatRegistrasiScreen extends StatefulWidget {
  ...
  @override
  State<RiwayatRegistrasiScreen> createState() =>
      _RiwayatRegistrasiScreenState();
}

class _RiwayatRegistrasiScreenState extends State<RiwayatRegistrasiScreen> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                    "Showing ${(_currentPage - 1) * _rowsPerPage + 1} to ${(_currentPage - 1) * _rowsPerPage + displayedData.length} of ${_filteredData.length} entries"),
                                Row(
                                  children: [
                                    TextButton(
