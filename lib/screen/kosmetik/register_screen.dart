...
class RegisterKosmetikScreen extends StatefulWidget {
  const RegisterKosmetikScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<RegisterKosmetikScreen> createState() => _RegisterKosmetikScreenState();
}

class _RegisterKosmetikScreenState extends State<RegisterKosmetikScreen> {
