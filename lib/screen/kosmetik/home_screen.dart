...
class HomeKosmetikScreen extends StatefulWidget {
  const HomeKosmetikScreen({
    Key? key,
  }) : super(key: key);

  @override
  _HomeKosmetikScreenState createState() => _HomeKosmetikScreenState();
}

class _HomeKosmetikScreenState extends State<HomeKosmetikScreen> {
                      ...
                      RichText(
                        text: TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(
                              text:
                                  'Konsultasi Dokter Ahli Di Aplikasi SIMKHM. ',
                              style: TextStyle(
                                fontSize: 10.0,
                                fontWeight: FontWeight.bold,
                                color: Colors.green,
