...
class LoginKosmetikScreen extends StatefulWidget {
  final String? emailFromRegister;

  const LoginKosmetikScreen({Key? key, this.emailFromRegister})
      : super(key: key);

  @override
  State<LoginKosmetikScreen> createState() => _LoginKosmetikScreenState();
}

class _LoginKosmetikScreenState extends State<LoginKosmetikScreen> {
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            ElevatedButton(
                              onPressed: () =>
                                  context.push('/register-kosmetik'),
