              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: [
                        Consumer<AddressProvider>(builder: (context, state, _) {
                          return Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: DropdownButton<ProvinceDistrictModel>(
                                    ...
                                    onChanged:
                                        (ProvinceDistrictModel? newProvince) {
                                      if (newProvince != null) {
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: DropdownButton<ProvinceDistrictModel>(
                                    ...
                                    onChanged:
                                        (ProvinceDistrictModel? newDistrict) {
                                      if (newDistrict != null) {
                                        state.getSubdistrict(newDistrict.id);
                                        setState(() {
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: DropdownButton<SubdistrictModel>(
                                    ...
                                    onChanged: (SubdistrictModel? newVillage) {
                                      if (newVillage != null) {
                                        setState(() {
